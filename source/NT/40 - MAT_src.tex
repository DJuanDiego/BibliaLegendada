...
\ChapOne{1}{\PP 
  \VerseOne{1}Livro da geração de Jesus Cristo, filho de Davi, filho de Abraão.
...
\Chap{2}{\PP 
  \VerseOne{1}E sendo Jesus já nascido em Belém da Judeia, nos dias do rei Herodes, eis que vieram uns magos do oriente a Jerusalém,
...
\Chap{3}{\PP 
  \VerseOne{1}E naqueles dias veio João Batista, pregando no deserto da Judeia,
...
\Chap{4}{\PP 
  \VerseOne{1}Então Jesus foi levado pelo Espírito ao deserto para ser tentado pelo diabo.
...
\Chap{6}{\PP 
  \VerseOne{1}Ficai atentos para que não façais vossa esmola diante das pessoas a fim de que sejais vistos por elas; de outra maneira não tereis recompensa de vosso Pai que está nos céus.
...
\Chap{7}{\PP 
  \VerseOne{1}Não julgueis, para que não sejais julgados.
...
\Chap{8}{\PP 
  \VerseOne{1}Quando ele desceu do monte, muitas multidões o seguiram.
...
\Chap{9}{\PP 
  \VerseOne{1}Então ele entrou no barco, passou para a outra margem, e veio à sua própria cidade.
...
\Chap{10}{\PP 
  \VerseOne{1}{\ADD{Jesus}} chamou a si os seus doze discípulos, e deu-lhes poder sobre os espíritos imundos, para os expulsarem, e curarem toda enfermidade e toda doença.
...
\Chap{11}{\PP 
  \VerseOne{1}Quando Jesus acabou de dar as ordens aos seus doze discípulos, partiu dali para ensinar e para pregar em suas cidades.
...
\Chap{12}{\PP 
  \VerseOne{1}Naquele tempo Jesus estava indo pelas plantações de cereais no sábado. Seus discípulos tinham fome, e começaram a arrancar espigas e a comer.
...
\Chap{13}{\PP 
  \VerseOne{1}Naquele dia, Jesus saiu de casa e se sentou junto ao mar.
...
\Chap{14}{\PP 
  \VerseOne{1}Naquele tempo Herodes, o tetrarca, ouviu relato a respeito de Jesus,
...
\Chap{16}{\PP 
  \VerseOne{1}Então os fariseus e os saduceus se aproximaram dele e, a fim de tentá-lo, pediram-lhe que lhes mostrasse algum sinal do céu.
...
\Chap{17}{\PP 
  \VerseOne{1}Seis dias depois, Jesus tomou consigo Pedro, Tiago, e seu irmão João, e os levou a sós a um monte alto.
...
\Chap{18}{\PP 
  \VerseOne{1}Naquela hora os discípulos se aproximaram de Jesus, e perguntaram: Ora, quem é o maior no Reino dos céus?
...
\Chap{19}{\PP 
  \VerseOne{1}E aconteceu que, quando Jesus acabou essas palavras, partiu da Galileia, e veio para a região da Judeia, além do Jordão.
...
\Chap{20}{\PP 
  \VerseOne{1}Pois o reino dos céus é semelhante a um homem, dono de propriedade, que saiu de madrugada para empregar trabalhadores para a sua vinha.
...
\Chap{21}{\PP 
  \VerseOne{1}E quando se aproximaram de Jerusalém, e chegaram a Betfagé, ao monte das Oliveiras, então Jesus mandou dois discípulos, dizendo-lhes:
...
\Chap{22}{\PP 
  \VerseOne{1}Então Jesus voltou a lhes falar por parábolas, dizendo:
...
\Chap{23}{\PP 
  \VerseOne{1}Então Jesus falou às multidões e aos seus discípulos,
...
\Chap{24}{\PP 
  \VerseOne{1}Jesus saiu do templo, e se foi. Então seus discípulos se aproximaram dele para lhe mostrarem os edifícios do complexo do templo.
...
\Chap{25}{\PP 
  \VerseOne{1}Então o Reino dos céus será semelhante a dez virgens, que tomaram suas lâmpadas, e saíram ao encontro do noivo.
...
\Chap{26}{\PP 
  \VerseOne{1}E aconteceu que, quando Jesus terminou todas estas palavras, disse aos seus discípulos:
...
\Chap{27}{\PP 
  \VerseOne{1}Vinda a manhã, todos os chefes dos sacerdotes e anciãos do povo juntamente se aconselharam contra Jesus, para o matarem.
...
\Chap{28}{\PP 
  \VerseOne{1}No fim do sábado, quando já começava a clarear para o primeiro dia da semana, Maria Madalena, e a outra Maria vieram ver o sepulcro.
