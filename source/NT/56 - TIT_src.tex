...
\ChapOne{1}{\PP 
  \VerseOne{1}Paulo, servo de Deus e apóstolo de Jesus Cristo, segundo a fé dos escolhidos de Deus, e o conhecimento da verdade, que é segundo a devoção divina;
...
\Chap{2}{\PP 
  \VerseOne{1}Tu, porém, fala o que convém à sã doutrina;
...
\Chap{3}{\PP 
  \VerseOne{1}Relembra-os para se sujeitarem aos governantes e às autoridades, sejam obedientes,
