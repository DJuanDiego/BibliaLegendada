...
\ChapOne{1}{\PP 
  \VerseOne{1}Paulo, apóstolo de Jesus Cristo pela vontade de Deus, e o irmão Timóteo,
...
\Chap{2}{\PP 
  \VerseOne{1}Pois quero que saibais como é grande a luta que tenho para o benefício de vós, dos que
...
\Chap{3}{\PP 
  \VerseOne{1}Portanto, se fostes ressuscitados com Cristo, buscai as coisas de cima, onde Cristo está sentado à direita de Deus.
...
\Chap{4}{\PP 
  \VerseOne{1}Senhores, procedei de maneira justa e imparcial com os
