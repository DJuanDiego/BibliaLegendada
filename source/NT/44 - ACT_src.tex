...
\ChapOne{1}{\PP 
  \VerseOne{1}Eu fiz o primeiro livro, ó Teófilo, sobre todas as coisas que Jesus começou, tanto a fazer como a ensinar;
...
\Chap{2}{\PP 
  \VerseOne{1}E ao se cumprir o dia de Pentecostes, estavam todos concordando no mesmo lugar.
...
\Chap{3}{\PP 
  \VerseOne{1}E Pedro e João estavam subindo juntos para o Templo à hora da oração (a nona
{\ADD{hora}} );
...
\Chap{4}{\PP 
  \VerseOne{1}E enquanto eles ainda estavam falando ao povo, vieram sobre eles os sacerdotes, e o oficial do Templo, e os saduceus,
...
\Chap{5}{\PP 
  \VerseOne{1}E um certo homem, de nome Ananias, com Safira, sua mulher, vendeu uma propriedade de terra.
  \VS{2}E escondeu
...
\Chap{6}{\PP 
  \VerseOne{1}Naqueles dias, ao se multiplicar
...
\Chap{7}{\PP 
  \VerseOne{1}E disse o chefe dos sacerdotes: Por acaso é isto assim?
...
\Chap{8}{\PP 
  \VerseOne{1}E Saulo também consentia na morte dele. E naquele dia foi feita uma grande perseguição contra a igreja que estava em Jerusalém; e todos foram dispersos pelas regiões da Judeia, e de Samaria, exceto os apóstolos.
  \VS{2}E
...
\Chap{9}{\PP 
  \VerseOne{1}E Saulo, ainda assoprando ameaças e mortes contra os discípulos do Senhor, foi ao chefe dos sacerdotes.
...
\Chap{10}{\PP 
  \VerseOne{1}E havia um certo homem em Cesareia, de nome Cornélio, centurião, do esquadrão chamado Italiano;
...
\Chap{11}{\PP 
  \VerseOne{1}E os apóstolos, e os irmãos que estavam na Judeia, ouviram que também os gentios receberam a palavra de Deus.
...
\Chap{12}{\PP 
  \VerseOne{1}E por aquele mesmo tempo o rei Herodes pôs as mãos para maltratar a alguns da igreja.
...
\Chap{13}{\PP 
  \VerseOne{1}E havia em Antioquia, na igreja que estava
...
\Chap{14}{\PP 
  \VerseOne{1}E aconteceu em Icônio, que entraram juntos na sinagoga dos judeus, e falaram de tal maneira que creu uma grande multidão, tanto de judeus como de gregos.
...
\Chap{15}{\PP 
  \VerseOne{1}E alguns que tinham descido da Judeia ensinavam aos irmãos,
...
\Chap{16}{\PP 
  \VerseOne{1}E ele veio a Derbe e Listra; e eis que estava ali um certo discípulo, de nome Timóteo, filho de uma certa mulher judia crente, mas de pai grego.
  \VS{2}Do qual era
...
\Chap{17}{\PP 
  \VerseOne{1}E viajando por Anfípolis e Apolônia, vieram a Tessalônica, onde havia uma sinagoga de judeus.
...
\Chap{18}{\PP 
  \VerseOne{1}E depois disto ele partiu de Atenas, e veio a Corinto.
...
\Chap{19}{\PP 
  \VerseOne{1}E enquanto Apolo estava em Corinto, aconteceu que, tendo Paulo passado por todas as regiões altas, ele veio a Éfeso; e achando
...
\Chap{20}{\PP 
  \VerseOne{1}E tendo acabado o tumulto, Paulo chamou a si os discípulos e, abraçando-os, saiu para ir à Macedônia.
...
\Chap{21}{\PP 
  \VerseOne{1}E quando aconteceu de termos saído deles, e navegado, percorremos diretamente, e viemos a Cós, e
{\ADD{n}} o
...
\Chap{22}{\PP 
  \VerseOne{1}Homens irmãos, e pais, ouvi agora minha defesa para convosco.
...
\Chap{23}{\PP 
  \VerseOne{1}E Paulo, olhando fixamente para o supremo conselho,
\FTNT{*}{{\FR 23:1 }
supremo conselho
lit. sinédrio – o mais importante conselho ou tribunal para os judeus
...
\Chap{24}{\PP 
  \VerseOne{1}E cinco dias depois, desceu o sumo sacerdote Ananias, com os anciãos e um certo orador Tértulo; os quais compareceram diante do governador contra Paulo.
...
\Chap{25}{\PP 
  \VerseOne{1}Então Festo, tendo entrado na província, subiu dali três dias depois de Cesareia a Jerusalém.
...
\Chap{26}{\PP 
  \VerseOne{1}E Agripa disse a Paulo: É permitido a ti falar por ti mesmo. Então Paulo, estendendo a mão, respondeu em sua defesa:
...
\Chap{27}{\PP 
  \VerseOne{1}E quando foi determinado que tínhamos que navegar para a Itália, entregaram a Paulo e alguns outros prisioneiros, a um centurião, por nome Júlio, do esquadrão imperial.
  \VS{2}E embarcando
...
\Chap{28}{\PP 
  \VerseOne{1}E tendo sobrevivido, então souberam que a ilha se chamava Malta.
