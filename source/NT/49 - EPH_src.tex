...
\ChapOne{1}{\PP 
  \VerseOne{1}Paulo, apóstolo de Jesus Cristo pela vontade de Deus, aos santos que estão em Éfeso, e fiéis em Cristo Jesus.
...
\Chap{2}{\PP 
  \VerseOne{1}E vós estáveis mortos em ofensas e pecados,
...
\Chap{4}{\PP 
  \VerseOne{1}Portanto, eu, o prisioneiro no Senhor, rogo-vos que andeis como é digno do chamado com que fostes chamados,
...
\Chap{5}{\PP 
  \VerseOne{1}Portanto, sede imitadores de Deus, como filhos amados;
...
\Chap{6}{\PP 
  \VerseOne{1}Filhos, sede obedientes aos vossos pais no Senhor, porque isso é justo.
