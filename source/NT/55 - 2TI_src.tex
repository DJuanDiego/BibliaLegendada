...
\ChapOne{1}{\PP 
  \VerseOne{1}Paulo, apóstolo de Jesus Cristo, pela vontade de Deus, segundo a promessa da vida que está em Cristo Jesus,
  \VS{2}a Timóteo,
...
\Chap{2}{\PP 
  \VerseOne{1}Portanto tu, meu filho, fortifica-te na graça que há em Cristo Jesus.
...
\Chap{3}{\PP 
  \VerseOne{1}Sabe porém isto, que nos últimos dias virão tempos difíceis.
...
\Chap{4}{\PP 
  \VerseOne{1}Portanto te convoco diante de Deus e do Senhor Jesus Cristo, que irá julgar os vivos e os mortos em sua aparição e seu reino:
