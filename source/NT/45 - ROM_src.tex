...
\ChapOne{1}{\PP 
  \VerseOne{1}Paulo, servo de Jesus Cristo, chamado
...
\Chap{3}{\PP 
  \VerseOne{1}Qual, pois, é a vantagem do judeu? Ou qual é a utilidade da circuncisão?
...
\Chap{4}{\PP 
  \VerseOne{1}Então, que diremos que Abraão, nosso ancestral
\FTNT{*}{{\FR 4:1 }
Lit. pai
...
\Chap{5}{\PP 
  \VerseOne{1}Portanto, agora que somos justificados pela fé, temos paz com Deus por meio do nosso Senhor Jesus Cristo.
...
\Chap{6}{\PP 
  \VerseOne{1}Que diremos, pois? Continuaremos no pecado, para que a graça aumente?
...
\Chap{7}{\PP 
  \VerseOne{1}Não sabeis vós, irmãos (pois estou falando com os que entendem a Lei), que a Lei domina o ser humano por todo o tempo que vive?
...
\Chap{8}{\PP 
  \VerseOne{1}Portanto, agora, nenhuma condenação há para os que estão em Cristo Jesus, que não andam segundo a carne, mas sim segundo o Espírito.
...
\Chap{9}{\PP 
  \VerseOne{1}Digo a verdade em Cristo, não minto, e minha consciência dá testemunho comigo pelo Espírito Santo,
...
\Chap{10}{\PP 
  \VerseOne{1}Irmãos, o bom desejo do meu coração, e a oração que
...
\Chap{11}{\PP 
  \VerseOne{1}Então pergunto: por acaso Deus rejeitou seu povo? De maneira nenhuma! Pois também eu sou israelita, da descendência
\FTNT{*}{{\FR 11:1 }
Lit. semente
...
\Chap{12}{\PP 
  \VerseOne{1}Rogo-vos, pois, irmãos, pelas misericórdias de Deus, que apresenteis os vossos corpos como sacrifício vivo, santo e agradável a Deus,
...
\Chap{13}{\PP 
  \VerseOne{1}Toda pessoa esteja sujeita às autoridades superiores, porque não há autoridade que não seja da parte de Deus; e as autoridades que existem são ordenadas por Deus.
...
\Chap{14}{\PP 
  \VerseOne{1}Recebei a quem for fraco na fé, mas não para
...
\Chap{15}{\PP 
  \VerseOne{1}Mas nós, que somos fortes, devemos suportar as fraquezas dos fracos, e não agradar a nós mesmos.
...
\Chap{16}{\PP 
  \VerseOne{1}Eu vos recomendo a nossa irmã Febe, que é servidora da Igreja que está em Cencreia,
