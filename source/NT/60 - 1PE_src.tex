...
\ChapOne{1}{\PP 
  \VerseOne{1}Pedro, apóstolo de Jesus Cristo, aos forasteiros que estão espalhados em Ponto, Galácia, Capadócia, Ásia e Bitínia,
...
\Chap{2}{\PP 
  \VerseOne{1}Abandonai, portanto, toda malícia, toda enganação, fingimentos, invejas, e todas as falas maldosas,
...
\Chap{3}{\PP 
  \VerseOne{1}Semelhantemente vós, esposas, estejais sujeitas aos próprios maridos, para que, ainda que alguns não obedeçam à Palavra, por meio do comportamento das esposas, sem palavra, sejam ganhos,
...
\Chap{4}{\PP 
  \VerseOne{1}Visto que Cristo sofreu por nós na carne, armai-vos também com o mesmo modo de pensar, pois quem sofreu na carne terminou com o pecado;
