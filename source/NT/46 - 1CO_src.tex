...
\ChapOne{1}{\PP 
  \VerseOne{1}Paulo, chamado apóstolo de Jesus Cristo pela vontade de Deus, e o irmão Sóstenes,
...
\Chap{2}{\PP 
  \VerseOne{1}E eu, irmãos, quando vim até vós, não vim vos anunciar o testemunho de Deus com excelência de palavras, ou sabedoria.
...
\Chap{3}{\PP 
  \VerseOne{1}E eu, irmãos, não pude vos falar como a espirituais, mas como a carnais, como a meninos em Cristo.
...
\Chap{4}{\PP 
  \VerseOne{1}Que as pessoas nos considerem como servidores de Cristo, e guardiões dos mistérios de Deus.
...
\Chap{6}{\PP 
  \VerseOne{1}Algum de vós, tendo um assunto contra outro, ousa ir a juízo perante os injustos, e não perante os santos?
...
\Chap{7}{\PP 
  \VerseOne{1}E sobre as coisas que me escrevestes, bom é para o homem não tocar mulher.
...
\Chap{8}{\PP 
  \VerseOne{1}E quanto às coisas sacrificadas aos ídolos, sabemos que todos temos conhecimento. O conhecimento incha
...
\Chap{9}{\PP 
  \VerseOne{1}Não sou eu apóstolo? Não sou livre? Não vi eu a Jesus Cristo nosso Senhor? Não sois vós minha obra no Senhor?
...
\Chap{10}{\PP 
  \VerseOne{1}Ora, irmãos, eu não quero que ignoreis que todos os nossos pais estiveram debaixo da nuvem, e todos pelo mar passaram;
...
\Chap{11}{\PP 
  \VerseOne{1}Sede meus imitadores, assim como eu também sou de Cristo.
...
\Chap{13}{\PP 
  \VerseOne{1}Ainda que eu falasse as línguas dos seres humanos e dos anjos, e não tivesse amor, seria como o metal que soa, ou como o sino que retine.
...
\Chap{14}{\PP 
  \VerseOne{1}Segui o amor, e desejai com zelo pelos
...
\Chap{15}{\PP 
  \VerseOne{1}Também irmãos, eu vos declaro o Evangelho, que já vos tenho anunciado, o qual também recebestes, no qual também estais.
...
\Chap{16}{\PP 
  \VerseOne{1}E quanto à coleta que
