...
\ChapOne{1}{\PP 
  \VerseOne{1}Paulo, apóstolo de Jesus Cristo segundo o mandado de Deus, nosso Salvador, e do Senhor Jesus Cristo, nossa esperança.
  \VS{2}Para Timóteo,
...
\Chap{2}{\PP 
  \VerseOne{1}Por isso eu te exorto, antes de tudo, que se façam pedidos, orações, intercessões
...
\Chap{4}{\PP 
  \VerseOne{1}Mas o Espírito diz expressamente que nos últimos tempos alguns se afastarão da fé, dando atenção a espíritos enganadores, e a doutrinas de demônios,
...
\Chap{5}{\PP 
  \VerseOne{1}Não repreendas ao idoso asperamente, mas exorta-o como a um pai; aos jovens, como a irmãos;
...
\Chap{6}{\PP 
  \VerseOne{1}Todos os servos que estão sob escravidão
\FTNT{*}{{\FR 6:1 }
Lit. jugo
