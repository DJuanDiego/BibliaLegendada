...
\ChapOne{1}{\PP 
  \VerseOne{1}Paulo, Silvano, e Timóteo, à igreja dos tessalonicenses, em Deus Pai, e no Senhor Jesus Cristo; haja convosco a graça e a paz de Deus, nosso Pai, e do Senhor Jesus Cristo.
...
\Chap{2}{\PP 
  \VerseOne{1}Pois vós mesmos, irmãos, sabeis que a nossa passagem por entre vós não foi inútil.
...
\Chap{3}{\PP 
  \VerseOne{1}Por isso, como não podíamos mais suportar, decidimos ficar sozinhos em Atenas,
...
\Chap{4}{\PP 
  \VerseOne{1}Portanto, irmãos, no restante, vos rogamos e exortamos no Senhor Jesus, que, assim como recebestes de nós como deveis andar e agradar a Deus, que façais
...
\Chap{5}{\PP 
  \VerseOne{1}Mas irmãos, acerca dos tempos e das estações, não necessitais de que eu vos escreva;
