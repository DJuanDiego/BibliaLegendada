...
\ChapOne{1}{\PP 
  \VerseOne{1}Provérbios de Salomão, filho de Davi, rei de Israel.
...
\Chap{2}{\PP 
  \VerseOne{1}Filho meu, se aceitares minhas palavras, e depositares em ti meus mandamentos,
...
\Chap{3}{\PP 
  \VerseOne{1}Filho meu, não te esqueças de minha lei; e que teu coração guarde meus mandamentos.
...
\Chap{4}{\PP 
  \VerseOne{1}Ouvi, filhos, a correção do pai; e prestai atenção, para que conheçais o entendimento.
...
\Chap{5}{\PP 
  \VerseOne{1}Filho meu, presta atenção à minha sabedoria, inclina teus ouvidos ao meu entendimento.
...
\Chap{6}{\PP 
  \VerseOne{1}Filho meu, se ficaste fiador por teu próximo,
...
\Chap{7}{\PP 
  \VerseOne{1}Filho meu, guarda minhas palavras; e deposita em ti meus mandamentos.
...
\Chap{8}{\PP 
  \VerseOne{1}Por acaso a sabedoria não clama, e a inteligência não solta sua voz?
...
\Chap{9}{\PP 
  \VerseOne{1}A verdadeira sabedoria edificou sua casa; ela lavrou suas sete colunas.
...
\Chap{10}{\PP 
  \VerseOne{1}Provérbios de Salomão:O filho sábio alegra ao pai; mas o filho tolo é tristeza para sua mãe.
...
\Chap{12}{\PP 
  \VerseOne{1}Aquele que ama a correção ama o conhecimento; mas aquele que odeia a repreensão é um bruto.
...
\Chap{14}{\PP 
  \VerseOne{1}Toda mulher sábia edifica sua casa; porém a tola a derruba com suas mãos.
...
\Chap{15}{\PP 
  \VerseOne{1}A resposta suave desvia o furor, mas a palavra pesada faz a ira aumentar.
...
\Chap{16}{\PP 
  \VerseOne{1}Do homem são os planejamentos do coração, mas a reposta da boca
{\ADD{vem}} do SENHOR.
...
\Chap{17}{\PP 
  \VerseOne{1}Melhor é um pedaço seco de comida com tranquilidade, do que uma casa cheia de carne com briga.
...
\Chap{18}{\PP 
  \VerseOne{1}Quem se isola busca seu
...
\Chap{19}{\PP 
  \VerseOne{1}Melhor é o pobre que anda em sua honestidade do que o perverso de lábios e tolo.
...
\Chap{20}{\PP 
  \VerseOne{1}O vinho é zombador, a bebida forte é causadora de alvoroços; e todo aquele que errar por causa deles não é sábio.
...
\Chap{21}{\PP 
  \VerseOne{1}{\ADD{Como}} ribeiros de águas é o coração do rei na mão do SENHOR, ele o conduz para onde quer.
...
\Chap{22}{\PP 
  \VerseOne{1}É preferível ter um
...
\Chap{23}{\PP 
  \VerseOne{1}Quando te sentares para comer com algum dominador, presta muita atenção para o que estiver diante de ti;
...
\Chap{24}{\PP 
  \VerseOne{1}Não tenhas inveja dos homens malignos, nem desejes estar com eles;
...
\Chap{25}{\PP 
  \VerseOne{1}Estes também são provérbios de Salomão, que foram copiados pelos homens de Ezequias, rei de Judá.
...
\Chap{26}{\PP 
  \VerseOne{1}Assim como a neve no verão, como a chuva na colheita, assim também não convém a honra para o tolo.
...
\Chap{27}{\PP 
  \VerseOne{1}Não te orgulhes do dia de amanhã; porque não sabes o que o dia trará.
...
\Chap{29}{\PP 
  \VerseOne{1}O homem que age com teimosia,
\FTNT{*}{{\FR 29:1 }
...
\Chap{30}{\PP 
  \VerseOne{1}Palavras de Agur, filho de Jaque, o de fala solene;
...
\Chap{31}{\PP 
  \VerseOne{1}Palavras do rei Lemuel, a profecia que sua mãe o ensinava.
  \VS{2}O que
