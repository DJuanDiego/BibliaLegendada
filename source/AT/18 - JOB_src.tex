...
\ChapOne{1}{\PP 
  \VerseOne{1}Havia um homem na terra de Uz, cujo nome era Jó; e este homem era íntegro e correto, temente a Deus, e que se afastava do mal.
...
\Chap{2}{\PP 
  \VerseOne{1}E veio outro dia em que os filhos de Deus vieram para se apresentarem diante do SENHOR, e e Satanás também veio entre eles para se apresentar diante do SENHOR.
...
\Chap{3}{\PP 
  \VerseOne{1}Depois disto Jó abriu sua boca, e amaldiçoou seu dia.
...
\Chap{4}{\PP 
  \VerseOne{1}Então Elifaz o temanita respondeu, dizendo:
...
\Chap{5}{\PP 
  \VerseOne{1}Clama agora! Haverá alguém que te responda? E a qual dos santos te voltarás?
...
\Chap{6}{\PP 
  \VerseOne{1}Mas Jó respondeu, dizendo:
...
\Chap{7}{\PP 
  \VerseOne{1}Por acaso o ser humano não tem um trabalho duro sobre a terra, e não são seus dias como os dias de um assalariado?
...
\Chap{8}{\PP 
  \VerseOne{1}Então Bildade, o suíta, respondeu, dizendo:
...
\Chap{10}{\PP 
  \VerseOne{1}Minha alma está cansada de minha vida. Darei liberdade à minha queixa sobre mim; falarei com amargura de minha alma.
...
\Chap{11}{\PP 
  \VerseOne{1}Então Zofar, o naamita, respondeu, dizendo:
...
\Chap{12}{\PP 
  \VerseOne{1}Porém Jó respondeu, dizendo:
...
\Chap{13}{\PP 
  \VerseOne{1}Eis que meus olhos têm visto tudo
...
\Chap{14}{\PP 
  \VerseOne{1}O homem, nascido de mulher, é curto de dias, e farto de inquietação;
...
\Chap{17}{\PP 
  \VerseOne{1}Meu espírito está arruinado, meus dias vão se extinguindo, e a sepultura já etá pronta para mim.
...
\Chap{20}{\PP 
  \VerseOne{1}E Zofar, o naamita, respondeu, dizendo:
...
\Chap{24}{\PP 
  \VerseOne{1}Por que os tempos não são marcados pelo Todo-Poderoso? Por que os que o conhecem não veem seus dias?
...
\Chap{27}{\PP 
  \VerseOne{1}E Jó prosseguiu em falar seu discurso, e disse:
...
\Chap{28}{\PP 
  \VerseOne{1}Certamente há minas para a prata, e o ouro lugar onde o derretem.
...
\Chap{29}{\PP 
  \VerseOne{1}E Jó continuou a falar seu discurso, dizendo:
...
\Chap{30}{\PP 
  \VerseOne{1}Porém agora riem de mim os mais jovens do que eu, cujos pais eu havia desdenhado até de os pôr com os cães de meu rebanho.
...
\Chap{31}{\PP 
  \VerseOne{1}Eu fiz um pacto com meus olhos; como, pois, eu olharia com cobiça para a virgem?
...
\Chap{32}{\PP 
  \VerseOne{1}Então aqueles três homens cessaram de responder a Jó, porque ele era justo em seus olhos.
...
\Chap{33}{\PP 
  \VerseOne{1}Portanto, Jó, ouve, por favor, meus dizeres, e dá ouvidos a todas as minhas palavras.
...
\Chap{34}{\PP 
  \VerseOne{1}Eliú respondeu mais, dizendo:
...
\Chap{36}{\PP 
  \VerseOne{1}Prosseguiu Eliú ainda, dizendo:
...
\Chap{37}{\PP 
  \VerseOne{1}Disto também o meu coração treme, e salta de seu lugar.
...
\Chap{38}{\PP 
  \VerseOne{1}Então o SENHOR respondeu a Jó desde um redemoinho, e disse:
...
\Chap{39}{\PP 
  \VerseOne{1}Sabes tu o tempo em que as cabras montesas dão filhotes? Ou observaste tu as cervas quando em trabalho de parto?
...
\Chap{40}{\PP 
  \VerseOne{1}Então o SENHOR respondeu mais a Jó, dizendo:
...
\Chap{41}{\PP 
  \VerseOne{1}Poderás tu pescar ao leviatã com anzol, ou abaixar sua língua com uma corda?
...
\Chap{42}{\PP 
  \VerseOne{1}E Jó respondeu ao SENHOR, dizendo:
