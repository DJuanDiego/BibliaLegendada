...
\ChapOne{1}{\PP 
  \VerseOne{1}Visão de Isaías, filho de Amoz, a qual ele viu sobre Judá e Jerusalém, nos dias de Uzias, Jotão, Acaz
...
\Chap{2}{\PP 
  \VerseOne{1}Palavra vista por Isaías, filho de Amoz, quanto a Judá e a Jerusalém:
...
\Chap{3}{\PP 
  \VerseOne{1}Porque eis que o Senhor DEUS dos exércitos tirará de Jerusalém e de Judá o apoio e o sustento:
\FTNT{*}{{\FR 3:1 }
...
\Chap{4}{\PP 
  \VerseOne{1}E sete mulheres tomarão um
...
\Chap{5}{\PP 
  \VerseOne{1}Agora cantarei a meu amado o cântico de meu querido de sua vinha: meu amado tem uma vinha, em um morro fértil;
...
\Chap{6}{\PP 
  \VerseOne{1}No ano em que o rei Uzias morreu, eu vi o Senhor sentado sobre um alto e elevado trono; e as bordas de seu manto enchiam o templo.
...
\Chap{7}{\PP 
  \VerseOne{1}Sucedeu, pois, nos dias de Acaz, filho de Jotão, filho de Uzias, rei de Judá, que, Rezim, rei da Síria, e Peca, filho de Remalias, rei de Israel, subiram a Jerusalém para fazerem guerra contra ela; mas não conseguiram vencer a batalha contra ela.
...
\Chap{8}{\PP 
  \VerseOne{1}Disse-me também o SENHOR: Toma para ti um grande letreiro, e escreve nele com pena
...
\Chap{10}{\PP 
  \VerseOne{1}Ai dos que decretam ordenanças injustas, e dos que escribas que escrevem coisas opressivas,
...
\Chap{11}{\PP 
  \VerseOne{1}E uma vara brotará do tronco cortado de Jessé; e um ramo crescerá de suas raízes.
...
\Chap{12}{\PP 
  \VerseOne{1}E tu dirás naquele dia: Eu te agradeço, SENHOR, pois, ainda que tenhas te irado contra mim, tua ira foi removida, e tu me consolas!
...
\Chap{13}{\PP 
  \VerseOne{1}Revelação sobre a Babilônia, vista por Isaías, filho de Amoz.
...
\Chap{14}{\PP 
  \VerseOne{1}Porque o SENHOR terá piedade de Jacó, e ainda escolherá a Israel, e os porá em sua terra; e estrangeiros se juntarão a eles, e se apegarão à casa de Jacó.
...
\Chap{15}{\PP 
  \VerseOne{1}Revelação sobre Moabe: Certamente em uma noite é destruída Ar-Moabe;
...
\Chap{16}{\PP 
  \VerseOne{1}Enviai os cordeiros ao dominador da terra desde Sela pelo deserto, ao monte da filha de Sião.
...
\Chap{17}{\PP 
  \VerseOne{1}Revelação sobre Damasco: Eis que Damasco será tirada
...
\Chap{18}{\PP 
  \VerseOne{1}Ai da terra dos zumbidos de asas, que está além dos rios de Cuxe,
...
\Chap{19}{\PP 
  \VerseOne{1}Revelação sobre o Egito: Eis que o SENHOR vem montado numa veloz nuvem, e ele virá ao Egito; e os ídolos do Egito tremerão perante sua presença; e o coração dos egípcios se derreterá dentro de si;
...
\Chap{20}{\PP 
  \VerseOne{1}No ano em que o general enviado por Sargom, rei da Assíria, veio a Asdode, guerreou contra Asdode, e a tomou,
...
\Chap{21}{\PP 
  \VerseOne{1}Revelação sobre o deserto do mar:Assim como os turbilhões de vento passam pelo Negueve, assim algo vem do deserto, de uma terra temível.
...
\Chap{22}{\PP 
  \VerseOne{1}Revelação sobre o vale da visão:O que há contigo, agora, para que tenhas subido toda aos terraços?
...
\Chap{23}{\PP 
  \VerseOne{1}Revelação sobre Tiro:Uivai, navios de Társis, pois ela está arruinada, sem sobrar casa alguma, nem entrada
...
\Chap{24}{\PP 
  \VerseOne{1}Eis que o SENHOR esvazia a terra, e a assola; e transtorna sua superfície, e espalha seus moradores.
  \VS{2}E
...
\Chap{25}{\PP 
  \VerseOne{1}Ó SENHOR, tu és meu Deus; eu te exaltarei,
...
\Chap{26}{\PP 
  \VerseOne{1}Naquele dia, se cantará este cântico na terra de Judá: Temos uma cidade forte!
...
\Chap{27}{\PP 
  \VerseOne{1}Naquele dia, o SENHOR punirá, com sua dura, grande e forte espada, ao Leviatã, a ágil serpente; ao Leviatã, a serpente tortuosa; e matará o dragão que está no mar.
...
\Chap{28}{\PP 
  \VerseOne{1}Ai da coroa de arrogância dos bêbados de Efraim, cujo belo ornamento é
...
\Chap{29}{\PP 
  \VerseOne{1}Ai de Ariel! Ariel, a cidade
...
\Chap{30}{\PP 
  \VerseOne{1}Ai dos filhos rebeldes!,diz o SENHOR, Eles, que tomam conselho, mas não de mim; que fazem um pacto, porém sem o meu Espírito, para acrescentarem pecado sobre pecado.
...
\Chap{31}{\PP 
  \VerseOne{1}Ai dos que descem ao Egito em busca de ajuda, e põem sua esperança em cavalos, e confiam em carruagens, por serem muitas, e em cavaleiros, por serem fortes; e não dão atenção ao Santo de Israel, nem buscam ao SENHOR.
...
\Chap{32}{\PP 
  \VerseOne{1}Eis que um rei reinará com justiça, e príncipes governarão conforme o juízo.
  \VS{2}E
...
\Chap{33}{\PP 
  \VerseOne{1}Ai de ti, assolador, que não foste assolado, e que enganas sem ter sido enganado! Quando terminares de assolar, tu é que serás assolado; quando terminares de enganar, então te enganarão.
...
\Chap{34}{\PP 
  \VerseOne{1}Vós nações, achegai-vos para ouvir; e vós povos, escutai; que a terra ouça, e tudo quanto ela contém;
\FTNT{*}{{\FR 34:1 }
...
\Chap{35}{\PP 
  \VerseOne{1}O deserto e o lugar seco terão prazer disto; e o lugar desabitado se alegrará e florescerá como a rosa.
\FTNT{*}{{\FR 35:1 }
rosa
...
\Chap{36}{\PP 
  \VerseOne{1}E aconteceu no décimo quarto ano do rei Ezequias, que Senaqueribe, rei da Assíria, subiu contra todas as cidades fortificadas de Judá, e as tomou.
...
\Chap{37}{\PP 
  \VerseOne{1}E aconteceu que, quando o rei Ezequias ouviu
...
\Chap{38}{\PP 
  \VerseOne{1}Naqueles dias Ezequias ficou doente, perto de morrer. E veio até ele Isaías, filho de Amoz, e lhe disse: Assim diz o SENHOR: Põe em ordem a tua casa, porque morrerás, e não viverás.
...
\Chap{39}{\PP 
  \VerseOne{1}Naquele tempo, Merodaque-Baladã, filho de Baladã, rei da Babilônia, enviou
...
\Chap{40}{\PP 
  \VerseOne{1}Consolai, consolai a meu povo, diz vosso Deus.
...
\Chap{41}{\PP 
  \VerseOne{1}Calai-vos perante mim, ó litorais; e os povos renovem as forças; aproximem-se,
...
\Chap{42}{\PP 
  \VerseOne{1}Eis aqui meu servo, a quem sustento; meu escolhido,
...
\Chap{43}{\PP 
  \VerseOne{1}Porém agora assim diz o SENHOR, o teu Criador, ó Jacó, e o teu Formador, ó Israel: Não temas, porque eu te resgatei; chamei a ti por teu nome; tu és meu.
...
\Chap{44}{\PP 
  \VerseOne{1}Agora, pois, ouve, ó Jacó, meu servo; tu, ó Israel, a quem escolhi.
...
\Chap{45}{\PP 
  \VerseOne{1}Assim diz o SENHOR a seu ungido, Ciro, ao qual tomou pela sua mão direita, para abater as nações diante dele, e tirar a proteção dos lombos dos reis; para abrir diante de sua presença as portas, e as portas não se fecharão:
...
\Chap{46}{\PP 
  \VerseOne{1}Bel se abaixa, Nebo se curva; seus ídolos são postos sobre os animais e sobre o gado; as cargas de vossos fardos são exaustivas para os
...
\Chap{47}{\PP 
  \VerseOne{1}Desce, e senta-te no pó da terra, ó virgem filha da Babilônia; senta-te no chão; já não há
...
\Chap{48}{\PP 
  \VerseOne{1}Ouvi isto, casa de Jacó, que vos chamais pelo nome de Israel, e saístes das águas de Judá;
\FTNT{*}{{\FR 48:1 }
...
\Chap{49}{\PP 
  \VerseOne{1}Ouvi-me, terras costeiras, e escutai, vós povos de longe; o SENHOR me chamou desde o ventre, desde as entranhas de minha mãe ele fez menção do meu nome;
...
\Chap{50}{\PP 
  \VerseOne{1}Assim diz o SENHOR: Onde está a carta de divórcio de vossa mãe, com que eu a mandei embora? Ou a qual dos meus credores foi que eu vos vendi? Eis que por vossas maldades fostes vendidos, e por vossas transgressões vossa mãe foi expulsa.
...
\Chap{51}{\PP 
  \VerseOne{1}Ouvi-me, vós que seguis a justiça, os que buscais ao SENHOR; olhai para a rocha
...
\Chap{52}{\PP 
  \VerseOne{1}Desperta-te! Desperta-te! Veste-te de tua força, ó Sião! Veste-te de teus belos vestidos, ó Jerusalém, cidade Santa! Porque nunca mais entrará em ti nem incircunciso nem impuro.
...
\Chap{53}{\PP 
  \VerseOne{1}Quem creu em nossa pregação?
\FTNT{*}{{\FR 53:1 }
em nossa pregação
...
\Chap{54}{\PP 
  \VerseOne{1}Canta alegremente, ó estéril,
...
\Chap{55}{\PP 
  \VerseOne{1}Ó todos vós que tendes sede, vinde às águas; e vós que não tendes dinheiro, vinde, comprai, e comei; vinde, comprai, sem dinheiro e sem preço, vinho e leite.
...
\Chap{56}{\PP 
  \VerseOne{1}Assim diz o SENHOR: Guardai o que é justo, e praticai a justiça; porque minha salvação já está perto de vir, e minha justiça de se manifestar.
...
\Chap{57}{\PP 
  \VerseOne{1}O justo perece, e ninguém há que pense nisso em seu coração; e os bons são levados, sem que ninguém dê atenção, que o justo é levado de diante do mal.
  \VS{2}Ele entrará
...
\Chap{58}{\PP 
  \VerseOne{1}Clama em alta voz, não te retenhas; levanta tua voz como trombeta; e anuncia a meu povo sua transgressão, e à casa de Jacó seus pecados.
...
\Chap{59}{\PP 
  \VerseOne{1}Eis que a mão do SENHOR não está encolhida, para que não possa salvar; nem seu ouvido surdo, para não poder ouvir.
...
\Chap{60}{\PP 
  \VerseOne{1}Levanta-te! Brilha! Porque já chegou a tua luz; e a glória do SENHOR já está raiando sobre ti.
...
\Chap{61}{\PP 
  \VerseOne{1}O Espírito do Senhor DEUS está sobre mim; pois o SENHOR me ungiu, para dar boas novas aos mansos; ele me enviou para sarar
\FTNT{*}{{\FR 61:1 }
sarar
...
\Chap{62}{\PP 
  \VerseOne{1}Por Sião eu não me calarei, e por Jerusalém não me aquietarei, enquanto sua justiça não sair como um brilho, e sua salvação como uma tocha acesa.
...
\Chap{63}{\PP 
  \VerseOne{1}Quem é este, que vem de Edom, de Bozra, com vestes salpicadas de vermelho, este ornado em sua vestimenta, que marcha com grande força? Eu, o que falo em justiça, poderoso para salvar.
...
\Chap{64}{\PP 
  \VerseOne{1}Ah, se tu rompesses os céus,
...
\Chap{65}{\PP 
  \VerseOne{1}Fui buscado por aqueles que não perguntavam
...
\Chap{66}{\PP 
  \VerseOne{1}Assim diz o SENHOR: Os céus são meu trono, e a terra o escabelo dos meus pés. Qual seria a casa que vós edificaríeis para mim? E qual seria o lugar de meu descanso?
