...
\ChapOne{1}{\PP 
  \VerseOne{1}E veio a palavra do SENHOR a Jonas, filho de Amitai, dizendo:
...
\Chap{2}{\PP 
  \VerseOne{1}E Jonas orou ao SENHOR seu Deus, desde as entranhas do peixe,
...
\Chap{3}{\PP 
  \VerseOne{1}E a palavra do SENHOR veio pela segunda vez a Jonas, dizendo:
...
\Chap{4}{\PP 
  \VerseOne{1}Mas Jonas se desgostou muito, e se encheu de ira.
